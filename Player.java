...
public class Player
{
    ...
    //variable para coger los objetos con las gafas.
    private boolean gafasCogidas;
    /**
    ...
    public Player(Room habitacion)
    {
        ...
        this.gafasCogidas=gafasCogidas;
    }
    ...
    public void take(String idObjeto){
        ...
        if(objetoDeLaSala != null){
            if(objetoDeLaSala.getPuedeSerCogido() || gafasCogidas){
    ...
    /**
     * Metodo para que el jugador con las gafas pueda ver y coger posibles objetos en el estadio.
     * @param idObjetoEspecial. Objeto que coincida con el id del objeto especial. 
     */
    public void gafas(String idObjetoEspecial){
        Item objetoDeLaSala = currentRoom.getListaObjeto(idObjetoEspecial); 
        if(objetoDeLaSala != null){
            listaDeObjetos.add(objetoDeLaSala);
            currentRoom.getEliminarObjeto(objetoDeLaSala);
            System.out.println("El objeto cogido con las gafas ha sido: " + objetoDeLaSala.getDescription());
        }else{
            System.out.println("Primero equipate de las gafas para poder coger cualquier objeto");
        }
    }
